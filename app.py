...
def ai_engine(df, history_count=10):
    ...
    for row in recent["normal"]:
        ...
        for i in range(len(nums)-1):
            ...
            if diff == 1:
                ...
                combo_counter[nums[i]] += 1
                combo_counter[nums[i+1]] += 1
    ...
    for i in range(len(top_numbers)):
        ...
        for j in range(i+1, len(top_numbers)):
    ...
    for i in range(len(top_numbers)):
        ...
        for j in range(i+1, len(top_numbers)):
            ...
            for k in range(j+1, len(top_numbers)):
...
def calculate_hit_rate(df, history_count=10):
    ...
    for i in range(history_count, len(df) - 1):
