...
# =====================================================
st.set_page_config(
    page_title="澳门六合彩 AI 超级智能系统 Ultimate",
    layout="wide"
)

st.title("澳门六合彩 AI 超级智能系统 Ultimate")
...
def yixiao_model(df,history_count):
    ...
    for idx,row in recent.iterrows():
        ...
        for n in row["normal"]:
            ...
            zodiac_score[get_zodiac(n)] += decay
    ...
    for z in ZODIAC_MAP:
        ...
        final[z]+=zodiac_score[z]
        final[z]+=special_zodiac[z]
